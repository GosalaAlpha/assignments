...
@RestController
//http://localhost:9091/api/employee
@RequestMapping("/api")
public class EmployeeController {
	...
	//@GetMapping("/employee")
	@GetMapping(path="/employees",value= {MediaType.APPLICATION_JSON_VALUE})
	//@GetMapping(path="/employee",employees= {MediaType.APPLICATION_ATOM_XML_VALUE})
